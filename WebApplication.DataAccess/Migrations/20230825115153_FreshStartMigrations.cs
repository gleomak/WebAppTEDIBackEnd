    ...
    public partial class FreshStartMigrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LandlordReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LandlordReviews_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResidenceReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResidenceReviews_Residences_ResidenceId",
                        column: x => x.ResidenceId,
                        principalTable: "Residences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "395fb3b3-a2ed-4943-b5e3-b276fcc85409", "462ffd34-182d-4791-89f7-1b60cb5a283b", "Host", "HOST" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "87549ac0-aeeb-47d3-9ac6-c61eda9a348b", "9532df5d-7bc6-4396-96b6-dc7cf8732acc", "Member", "MEMBER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "8cdc7e44-0df3-4fb4-9ea8-3745f590573f", "2deed552-8e5b-4616-81b7-0e2e6a2774c2", "Admin", "ADMIN" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LandlordReviews_UserId",
                table: "LandlordReviews",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResidenceReviews_ResidenceId",
                table: "ResidenceReviews",
                column: "ResidenceId");
        }
